...
namespace Persistence.Migrations
{
    ...
    [Migration("20240410094825_init4")]
    partial class init4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("39e946d9-d6ec-4f77-9a0f-cb57f16de063"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 186, 69, 202, 50, 132, 68, 174, 171, 178, 157, 108, 202, 170, 42, 69, 201, 192, 195, 10, 215, 94, 168, 59, 158, 159, 67, 10, 23, 84, 0, 173, 149, 124, 58, 28, 87, 12, 167, 229, 49, 131, 244, 245, 65, 65, 247, 38, 251, 95, 10, 153, 14, 247, 26, 238, 131, 209, 156, 224, 252, 2, 17, 250, 122 },
                            PasswordSalt = new byte[] { 244, 255, 165, 132, 214, 101, 53, 149, 75, 73, 6, 92, 48, 84, 150, 188, 55, 32, 196, 171, 3, 175, 169, 90, 135, 186, 210, 109, 82, 220, 144, 196, 157, 21, 144, 128, 38, 13, 209, 53, 51, 146, 33, 93, 228, 136, 82, 186, 192, 234, 31, 251, 55, 65, 204, 228, 188, 19, 35, 254, 107, 126, 116, 244, 61, 125, 29, 90, 165, 108, 108, 77, 225, 165, 168, 69, 116, 194, 160, 49, 209, 10, 35, 240, 219, 135, 159, 130, 101, 16, 115, 230, 134, 17, 162, 151, 146, 64, 159, 41, 26, 190, 209, 86, 27, 214, 238, 178, 52, 61, 203, 59, 136, 219, 182, 93, 54, 115, 22, 22, 59, 74, 47, 128, 19, 96, 154, 162 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("24a03e21-f382-4f47-a6d0-7bc6a9a4a3c1"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("39e946d9-d6ec-4f77-9a0f-cb57f16de063")
                        });
                });
